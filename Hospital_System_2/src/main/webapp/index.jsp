...
In An Emergency. 24/7 Assistance guaranteed.</p>
		...
		<section class="ftco-intro" style="background-image: url(images/bg_3.jpg);" data-stellar-background-ratio="2.0">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-9">
						...
						<div style="id=header width: 50px"><img src="images\card.png"></div>
					</div>
