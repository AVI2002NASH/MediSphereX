    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-lg-2 pr-4 align-items-center">
		    		<a class="navbar-brand" href="index.jsp">Medi<span>SphereX</span></a>
	    		</div>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item"><a href="user_appointment.jsp" class="nav-link">Appointment</a></li>
              	                          <li class="nav-item"><a href="doctor_login.jsp" class="nav-link">Doctor Login</a></li>
              	            
                              <li class="nav-item"><a href="user_login.jsp" class="nav-link">User</a></li>
              
              <li class="nav-item"><a href="admin_login.jsp" class="nav-link"><i class="fa-solid fa-right-to-bracket"></i> Admin</a></li>
