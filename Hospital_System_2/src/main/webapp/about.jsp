							...
							<div class="row mt-5 pt-2">
								<div class="col-lg-6">
									<div class="services-2 d-flex">
										...
										<div class="text">
											<h3>Primary Care</h3>
											<p>Our dedicated team of healthcare professionals is committed to providing personalized care.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-6">
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  ...
                  <div class="text ml-2 bg-light">
                    ...
                    <p class="name">Harshdeep Singh</p>
